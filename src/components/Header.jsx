      ...
      >
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          <IconButton
            ...
            icon={
              isOpen ? (
                <CloseIcon fontSize="sm" color="siteGray" />
              ) : (
                <HamburgerIcon fontSize="xl" color="siteGray" />
              )
            }
          ...
          <Flex alignItems={'center'}>
            <InputGroup display={{ base: 'none', md: 'flex' }} mr="1em">
                ...
                <Menu>
                  ...
                  <MenuList>
                    <MenuItem
                      onClick={() =>
                        navigate(
                          `/users/${user.displayName.split(' ')[0]}/shots`
                        )
                      }
                    >
                      Profile
                    ...
                    <MenuItem
                      onClick={() =>
                        navigate(
                          `/users/${user.displayName.split(' ')[0]}/about`
                        )
                      }
                    >
                      Edit Profile
                    ...
                    <MenuItem
                      onClick={() =>
                        navigate(
                          `/users/${user.displayName.split(' ')[0]}/likes`
                        )
                      }
                    >
                      My Likes
